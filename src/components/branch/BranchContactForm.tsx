...
const BranchContactForm: React.FC<ContactFormProps> = ({ branchId }) => {
    ...
    <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-lg p-8">
      ...
      <div className="mb-6">
        ...
        <textarea
          ...
          className={`w-full rounded-lg border px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-blue-500 ${errors.message ? 'border-red-300' : 'border-gray-300'}`}
