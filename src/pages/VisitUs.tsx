    ...
    <HelmetProvider>
      <div className="min-h-screen bg-gray-50">
        <SEOHead
          ...
          description="Plan your visit to Enlightened Christian Gathering — fill out the form and a member of our team will be in touch."
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-40 pb-24 text-center">
            ...
            >
              ...
              <p className="text-xl text-blue-100 max-w-2xl mx-auto leading-relaxed">
                Thanks for considering Enlightened Christian Gathering — fill out the form below
